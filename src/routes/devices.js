...
const {newDevice, devicesByPage, findById, getDeviceHistory, 
    getDeviceFilters, fullDeviceOptions, getDevices, allDevices, devicesByLine, devicesByName, getOptions} = require('../controllers/deviceController')
